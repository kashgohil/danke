        ...
        <div className="flex flex-col md:flex-row gap-8 md:justify-between">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-purple-600">Danke</span>
            </div>
            <p className="text-gray-600 text-sm leading-relaxed max-w-sm">
              Create beautiful appreciation boards to celebrate moments, share
              gratitude, and build stronger connections with your community.
            </p>
        ...
        <div className="border-t border-gray-200 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-sm text-gray-600">
              © {year} Danke. All rights reserved.
            </div>
