...
import { Activity, AlertCircle, Calendar, Edit, Mail, RefreshCw, Settings, User } from "lucide-react";
import { useAuth } from "./auth-context";

export function UserProfile() {
	const { user, isLoading, error, refreshUser, clearError, isAuthenticated } = useAuth();
				...
				<Card className="border-0 shadow-lg">
					<CardContent className="pt-8">
						<div className="text-center space-y-6">
							...
							<div>
								<h3 className="text-xl font-semibold text-red-600 mb-3">Profile Loading Error</h3>
						...
						<div className="space-y-4">
							...
							<div className="space-y-3">
								<div className="flex items-center p-3 rounded-lg bg-muted/50 border">
									...
									<p className="text-sm text-danke-600 dark:text-danke-300">{user.email}</p>
								</div>
								<div className="flex items-center p-3 rounded-lg bg-muted/50 border">
						...
						<div className="space-y-4">
							...
							<div className="space-y-3">
								<div className="p-3 rounded-lg  bg-muted/50 border">
									<div className="flex items-center justify-between">
										<div className="flex items-center gap-2">
											<p className="text-sm text-danke-800 dark:text-danke-200">Status: </p>
											<p className="text-sm text-danke-600 dark:text-danke-300">Active</p>
										</div>
								...
								<div className="p-3 rounded-lg  bg-muted/50 border">
									<div className="flex items-center justify-between">
										<div className="flex items-center gap-2">
											<p className="text-sm text-danke-800 dark:text-danke-200">Last Updated at </p>
											<p className="text-sm text-danke-600 dark:text-danke-300">
