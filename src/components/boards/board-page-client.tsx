...
export function BoardPageClient({ initialBoard, boardId, isModerator, isCreator }: BoardPageClientProps) {
	...
	const fetchPosts = useCallback(
		async (page: number = 1, append: boolean = false) => {
			try {
				...
				const response = await apiRequest<PostsResponse>(`/api/boards/${boardId}/posts?page=${page}&limit=50`);
	...
	return (
		<div>
			<BoardView
				...
				isCreator={isCreator}
				onFetchMorePosts={() => fetchPosts(pagination!.page + 1, true)}
