    ...
    <div className="space-y-16 mt-8 mx-auto">
      <section className="text-center">
        ...
        <p className="text-xl max-w-3xl mx-auto leading-relaxed text-danke-900">
          Master the art of appreciation with our step-by-step guides, best
          practices, and expert tips for creating meaningful boards that bring
      ...
      <section className="py-16 -mx-4 px-4">
        <div className="mx-auto">
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <MoveRight size={84} className="hidden md:block text-danke-900" />
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>
                Create meaningful goodbye experiences with tips for collecting
                heartfelt messages, organizing team contributions, and
                presenting the final board.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>
                Make birthdays special with photo collections, surprise
                coordination, and creative message prompts that capture
                cherished memories.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>
                Celebrate achievements and milestones with structured feedback,
                peer recognition, and professional presentation formats.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>
                Capture special moments from weddings, graduations, and
                community events with multimedia collections and guest
                contributions.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>
                Collect authentic feedback and testimonials with professional
                formatting, easy sharing, and integration with marketing
                materials.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300">
            <CardHeader>
              ...
              <CardDescription>
                Create lasting tributes with sensitive moderation, family
                collaboration, and meaningful ways to preserve and share
                memories.
              </CardDescription>
            </CardHeader>
          </Card>
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Send personal invitations with context about why their
                ...
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Provide example messages or prompts to help people get
                    started
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Set a deadline to create urgency and ensure timely
                    participation
                  </span>
                </li>
                <li className="flex items-start gap-3">
            ...
            <div className="space-y-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Choose meaningful timing that aligns with the occasion or
                    milestone
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Curate and organize messages before the big reveal for
                    maximum impact
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Present the board in person when possible for an emotional
                    moment
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span>
                    Create a lasting keepsake by exporting or printing the final
                    board
                  </span>
                </li>
              </ul>
      ...
      <section className="py-16 -mx-4 px-4 bg-background/50 backdrop-blur-lg md:rounded-lg">
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-danke-900">
              Can I moderate messages before they appear?
            </h3>
            <p className="text-muted-foreground">
              Yes! You can enable moderation to review all messages before they
              go live on your board. This ensures quality control and
              appropriateness for your specific occasion.
            </p>
          </div>

          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-danke-900">
              What file types can contributors upload?
            </h3>
            <p className="text-muted-foreground">
              Contributors can upload images (JPG, PNG, GIF), videos (MP4, MOV),
              and audio files (MP3, WAV). We automatically optimize media for
              fast loading while maintaining quality.
            </p>
          </div>

          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-danke-900">
              How long do boards stay active?
            </h3>
            <p className="text-muted-foreground">
              Boards remain active indefinitely on our free plan. You can
              archive or delete them at any time, and premium plans offer
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-semibold text-danke-900">
              Can I export my board for offline use?
            </h3>
            <p className="text-muted-foreground">
              Absolutely! You can export your board as a PDF, create a digital
              archive, or even order a printed version. This makes it perfect
              for creating lasting keepsakes.
            </p>
          </div>
        </div>
      </section>
