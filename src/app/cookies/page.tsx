...
export const metadata: Metadata = {
  ...
  description:
    'Learn about how Danke uses cookies and similar technologies to enhance your experience.',
};
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="leading-relaxed mb-4">
              Danke uses cookies and similar technologies to enhance your
              experience on our platform. We use cookies for the following
              purposes:
            </p>
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                ...
                you use our service and improve its performance
              </li>
              <li>
          ...
          <section className="mb-12">
            ...
            <p className="leading-relaxed mb-4">
              ...
              areas, and user authentication. The website cannot function
            ...
            <p className="leading-relaxed mb-4">
              ...
              get error messages. This information helps us improve how our
              website works.
            </p>
            <div className="bg-background/50 backdrop-blur-2xl rounded-lg p-4 mb-6">
              <p className="text-sm text-muted-foreground">
            ...
            <p className="leading-relaxed mb-4">
              ...
              your interests. They may be used to deliver targeted advertising
              or to limit the number of times you see an advertisement.
            </p>
            <div className="bg-background/50 backdrop-blur-2xl rounded-lg p-4">
              <p className="text-sm text-muted-foreground">
                <strong>Note:</strong> We currently do not use targeting cookies
          ...
          <section className="mb-12">
            ...
            <p className="leading-relaxed mb-4">
              ...
              services help us provide better functionality and understand how
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Authentication providers:</strong> Enable secure login
                functionality
              </li>
              <li>
                <strong>Content delivery networks:</strong> Improve website
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Essential cookies:</strong> Disabling these will prevent
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>
                <strong>Preference cookies:</strong> May persist for up to 1
                year
              </li>
            </ul>
          </section>
