				...
				<div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
					...
					<Card className="border-2 border-danke-gold shadow-xl hover:shadow-2xl transition-all duration-300 relative scale-105">
						...
						<div className="px-8 pb-8">
							...
							<Link
								...
								className="block"
							>
								<Button className="w-full bg-danke-gold hover:bg-danke-gold/90 text-danke-900">Start Pro Trial</Button>
							</Link>
						</div>
					</Card>
					...
					<Card className="border-2 border-border shadow-lg hover:shadow-xl transition-all duration-300 relative">
						<CardHeader className="text-center p-8">
							...
							<div className="text-4xl font-bold text-danke-gold mb-2">Custom</div>
				...
				<div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
					<Card className="border-0 shadow-lg text-center">
						<CardHeader>
							...
							<CardTitle className="text-2xl text-danke-gold">10,000+</CardTitle>
					...
					<Card className="border-0 shadow-lg text-center">
						<CardHeader>
							...
							<CardTitle className="text-2xl text-danke-gold">500,000+</CardTitle>
