...
import { Heart, ImageIcon, MessageCircle, Sparkles, Users, Video } from "lucide-react";
				...
				<div className="container mx-auto text-center">
					<div className="max-w-4xl mx-auto">
						...
						<p className="text-xl md:text-2xl text-danke-900 dark:text-danke-900 mb-8 max-w-3xl mx-auto leading-relaxed">
							Collect heartfelt messages, memories, and celebrations from your community. Share the love and create
							lasting connections.
						</p>
			...
			<section className="py-20 px-4 bg-background/50">
				<div className="container mx-auto">
					<div className="text-center mb-16">
						<h2 className="text-3xl md:text-4xl font-bold mb-4">Everything you need to celebrate together</h2>
						<p className="text-lg text-muted-foreground max-w-2xl mx-auto">
							Powerful features to make your appreciation boards beautiful, engaging, and memorable.
						</p>
					</div>
					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
						<Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									Write beautiful messages with formatting, colors, and styling to express your appreciation.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									Add photos, videos, and audio to make your messages even more special and personal.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									Share your board with unique links. Control who can view and who can contribute.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									Automatic masonry layouts that look great on any device, from mobile to desktop.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									See new messages appear instantly as your community shares their appreciation.
								</CardDescription>
							</CardHeader>
						</Card>
						...
						<Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
							<CardHeader>
								...
								<CardDescription>
									Full control over your boards with moderation tools and privacy settings.
								</CardDescription>
							</CardHeader>
						</Card>
					</div>
				...
				<div className="container mx-auto text-center">
					<div className="max-w-3xl mx-auto">
						...
						<p className="text-xl mb-8 text-danke-900 dark:text-danke-900">
							Join thousands of people who are already creating beautiful appreciation boards.
						</p>
