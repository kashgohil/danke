        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className=" leading-relaxed">
              ...
              includes features for creating boards, posting content, managing
              permissions, and collaborating with others.
            </p>
          </section>
          ...
          <section className="mb-12">
            ...
            <p className=" leading-relaxed">
              ...
              are owned by Danke and are protected by international copyright,
          ...
          <section className="mb-12">
            ...
            <p className=" leading-relaxed">
              ...
              <Link href="/privacy" className="text-danke-gold hover:underline">
                Privacy Policy
              </Link>
          ...
          <section className="mb-12">
            ...
            <p className=" leading-relaxed">
              ...
              incidental, punitive, consequential, or special damages arising
              out of or related to your use of the Service, even if we have been
          ...
          <section className="mb-12">
            ...
            <p className=" leading-relaxed">
              You agree to defend, indemnify, and hold harmless Danke and its
          ...
          <section className="mb-12">
            ...
            <p className=" leading-relaxed">
              ...
              jurisdiction in which Danke operates, without regard to its
