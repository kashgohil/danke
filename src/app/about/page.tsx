    ...
    <div className="space-y-16 mt-8 mx-auto">
      <section className="text-center">
        ...
        <p className="text-xl max-w-3xl mx-auto leading-relaxed text-danke-900">
          We believe in the power of gratitude to strengthen communities and
      ...
      <section>
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-danke-900 mb-12">
            Our Mission
          </h2>
          <div className="prose prose-lg mx-auto text-danke-900">
            <p>
              Danke was born from a simple observation: in our fast-paced
              digital world, we often forget to pause and appreciate the people
              and moments that make our lives meaningful. We created Danke to
              bridge that gap, providing a beautiful, intuitive platform where
              communities can come together to celebrate achievements, share
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
            <CardHeader className="flex flex-col gap-2">
              ...
              <CardDescription>
                We believe gratitude is the foundation of strong relationships
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
            <CardHeader className="flex flex-col gap-2">
              ...
              <CardDescription>
                Every feature we build is designed to bring people together and
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
            <CardHeader className="flex flex-col gap-2">
              ...
              <CardDescription>
                We make complex interactions simple, so you can focus on what
                matters most.
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1 text-center">
            <CardHeader className="flex flex-col gap-2">
              ...
              <CardDescription>
                Your data and privacy are sacred to us. We build with security
      ...
      <section>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg mx-auto text-danke-900">
            <p>
              Danke started as a weekend project when our founder noticed how
              difficult it was to coordinate appreciation messages for a
              departing colleague. What began as a simple solution for
              collecting thank-you notes evolved into something much bigger: a
              platform that could help any community celebrate their special
              moments.
            </p>
            <p>
      ...
      <section className="py-16 -mx-4 px-4 bg-background/50 backdrop-blur-lg rounded-lg text-center">
        <h2 className="text-3xl font-bold mb-6 text-danke-gold">
          Get in Touch
        </h2>
